...
function AnimatedCounter({ target, decimalPlaces = 0 }) {
...
function About4() {
  return (
    <div className='h-[50vh] w-full bg-[orangered] grid place-items-center'>
      <div className='flex flex-wrap justify-center gap-[20px] w-full p-4'>
        ...
        <div className='flex flex-col items-center gap-2 w-[90%] md:w-[30%]'>
          <div className='flex items-center'>
            <AnimatedCounter target={100} decimalPlaces={0} />
        ...
        <div className='flex flex-col items-center gap-2 w-[90%] md:w-[30%]'>
          <div className='flex items-center'>
            <AnimatedCounter target={50} decimalPlaces={0} />
          </div>
          <h1 className='text-[20px] text-[white] font-bold text-center'>
            Exam Administered
          </h1>
        ...
        <div className='flex flex-col items-center gap-2 w-[90%] md:w-[30%]'>
          <div className='flex items-center'>
            <AnimatedCounter target={4.5} decimalPlaces={1} />
